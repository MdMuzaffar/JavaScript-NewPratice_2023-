...
function setDate() {
    const secondHands = document.querySelector('.secondsHand');
    const minutesHands = document.querySelector('.minutesHand');
    const hoursHands = document.querySelector('.hourHand');

    const now = new Date();

    const seconds = now.getSeconds();
    const secondsDegree = ((seconds / 60) * 360) + 90;
    secondHands.style.transform = `rotate(${secondsDegree}deg)`;

    const minutes = now.getMinutes();
    const minutesDegree = ((minutes / 60) * 360) + 90;
    minutesHands.style.transform = `rotate(${minutesDegree}deg)`;
